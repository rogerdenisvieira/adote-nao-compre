...
from AdoteNaoCompreSITE.controllers import home_controller, account_controller, dog_controller, generic_controller, user_controller
...
urlpatterns = [
    ...
    url(r'^dog/search', dog_controller.search),
